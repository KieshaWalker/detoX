...
# from .models import Invitation --- IGNORE ---
# from .forms import InvitationForm --- IGNORE ---
# class InvitationFormTest(TestCase): --- IGNORE ---
#     def test_invitation_form_valid(self): --- IGNORE ---
#         form_data = {'email': '   test@example.com   '} --- IGNORE ---
